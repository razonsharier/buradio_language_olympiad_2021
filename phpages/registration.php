...
if (isset($_POST['registration'])) {
 ...
 if (!$_POST["name"]) {
  ...
  $sql2  = "INSERT INTO reg (userid, ip, name, mobile, email, roll, pass, step1, marks1, selectionround2, topic, status, marks2, selectionround3, time, link, marks3, questart, quend) VALUES ('$uid','$ip', '$name', '$mobile', '$email', '$roll', '$password', '', '0', '', '', '', '0', '', '', '', '0', '', '')";
    ...
    <div id="bodycontainer">
        ...
        <div id="notice">
            <div class="noticetext">
                <p>মাতৃভাষা অলিম্পিয়াডে অংশগ্রহণ করতে রেজিস্ট্রেশন করুন।</p>
            </div>
        </div>
        <div id="loginfield">
